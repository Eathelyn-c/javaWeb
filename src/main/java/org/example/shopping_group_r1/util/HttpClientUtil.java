...
public class HttpClientUtil {
    ...
    public static String sendPostRequest(String requestBody) throws Exception {
        ...
        System.out.println("✓ 已设置 X-API-Key:  " + API_KEY);
    ...
    // 在 HttpClientUtil 类中添加以下方法
    public static String fetchAds() throws Exception {
        System.out.println("\n========== 开始获取广告数据 ==========");

        URL url = new URL("http://10.100.164.6:8080/ad-management/api/external/api/getAds");
        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
        ...
        try {
            ...
            String requestBody = "{\"platform\":\"shopping\"}";  // 修改这里！
